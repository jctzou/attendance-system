...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 dark:bg-neutral-950 p-4">
            <div className="w-full max-w-md bg-white dark:bg-neutral-900 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-slate-200 dark:border-neutral-800 p-8 sm:p-10">

                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-neutral-100 mb-2">
                        員工系統登入
                    </h1>
                ...
                <div className="space-y-5">
                    <div className="space-y-1.5">
                        ...
                        <input
                            className="w-full rounded-lg px-4 py-2.5 bg-white dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-800 dark:text-neutral-200 placeholder:text-slate-400"
                            value={email}
